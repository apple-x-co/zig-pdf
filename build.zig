...
pub fn build(b: *std.Build) void {
    ...
    exe.addIncludePath(std.Build.LazyPath{ .path = "/usr/local/include" }); // ex: hpdf.h
    exe.addLibraryPath(std.Build.LazyPath{ .path = "/opt/homebrew/Cellar/libharu/2.4.3/lib" }); // ex: libhpdf.a
    exe.addLibraryPath(std.Build.LazyPath{ .path = "/usr/local/lib" }); // ex: libhpdf.a
    exe.addLibraryPath(std.Build.LazyPath{ .path = "/usr/local/libiconv/lib" });
